namespace DSProductDesigner.Module.Win.Module.Controlls {
    partial class DSViewPort {
        ...
        {
            devDept.Eyeshot.Control.ProgressBar progressBar1 = new devDept.Eyeshot.Control.ProgressBar(devDept.Eyeshot.Control.ProgressBar.styleType.Speedometer, 0, "Idle", "Idle", Color.Black, Color.Transparent, Color.Green, 1D, false, false, 0.1D, 0.333D, true, true);
            ...
            devDept.Eyeshot.Camera camera1 = new devDept.Eyeshot.Camera(new devDept.Geometry.Point3D(0D, 0D, 45D), 380D, new devDept.Geometry.Quaternion(0.018434349666532526D, 0.039532590434972079D, 0.42221602280006187D, 0.90544518284475428D), devDept.Eyeshot.projectionType.Perspective, 40D, 8.1599960868061157D, false, 0.001D);
            ...
            devDept.Eyeshot.Control.Legend legend1 = new devDept.Eyeshot.Control.Legend(0D, 100D, "Title", "Subtitle", true, false, false, "{0:+0.###;-0.###;0}", Color.Transparent, Color.Black, Color.Black, null, null, new devDept.Eyeshot.Control.LegendItem[] { legendItem1, legendItem2, legendItem3, legendItem4, legendItem5, legendItem6, legendItem7, legendItem8, legendItem9 }, true, false, false, 0, devDept.Eyeshot.Control.Legend.positionType.TopLeft);
            ...
            devDept.Eyeshot.Control.ScaleBar scaleBar1 = new devDept.Eyeshot.Control.ScaleBar(false, Color.Black, Color.White, Color.Black, "{0:G6}", false, devDept.Eyeshot.Control.ScaleBar.styleType.Alternate, 4, 15, 0.4D, devDept.Eyeshot.Control.ScaleBar.positionType.BottomCenter, null, null);
            devDept.Eyeshot.Control.Viewport viewport1 = new devDept.Eyeshot.Control.Viewport(new Point(0, 0), new Size(1281, 816), backgroundSettings1, camera1, new devDept.Eyeshot.Control.ToolBar[] { toolBar1 }, new devDept.Eyeshot.Control.Legend[] { legend1 }, histogram1, devDept.Eyeshot.displayType.Rendered, true, false, false, new devDept.Eyeshot.Control.Grid[] { grid1 }, new devDept.Eyeshot.Control.OriginSymbol[] { originSymbol1 }, false, rotateSettings1, zoomSettings1, panSettings1, navigationSettings1, coordinateSystemIcon1, viewCubeIcon1, scaleBar1);
            design1 = new DSDesign();
            ...
            design1.Location = new Point(3, 3);
            design1.Name = "design1";
            design1.ProgressBar = progressBar1;
            design1.Size = new Size(1281, 816);
            design1.TabIndex = 0;
